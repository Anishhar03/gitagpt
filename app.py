...
# ------------------- Chat Interface -------------------
    ...
    with st.sidebar:
        ...
        def save_transcript(chat):
            ...
            # fpdf2.output(dest='S') returns a bytearray, which needs to be converted to bytes for Streamlit.
            # Addressing DeprecationWarning: "dest" parameter is deprecated. pdf.output() by default returns bytes.
